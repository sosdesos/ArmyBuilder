...
{
	public class ArmyModelBLL
	{	// this class contains info from both the many to many and models. 
		...
		public ArmyModelBLL(ArmyModelDAL Model)
		{   // we can populate the class with values from the Data access layer
			...
			FullSquats = Model.FullSquats;
		}
		public ArmyModelBLL()
		{
			//The default constructor(required for MVC)
		}
		public ArmyModelDAL ToDAL()
		...
		{// the Tostring is to test stuff in a console app.
			return $"{ModelID,3} {ModelName,20} {FactionName,20} {ModelType,3} {PointCost,4} {Quantity,4} {FullSquats,4}";
		}
	}
}
